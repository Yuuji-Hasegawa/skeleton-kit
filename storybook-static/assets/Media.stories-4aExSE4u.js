/* empty css                *//* empty css               *//* empty css                 *//* empty css                    *//* empty css             *//* empty css                */import{l as M,s as _}from"./set-int-size-DZc624IO.js";/* empty css                *//* empty css              */const G=({size:r})=>{const a=document.createElement("div");return a.className="o-sdb c-mda",a.style.backgroundColor="var(--c-fill-neutral)",r&&a.classList.add("u-ins-sdb",`u-space-${r}`),a.innerHTML=`
        ...
        <div class="c-mda__txt">
          ...
          <span class="c-lbl-l u-py-xs u-px-s" style="background-color: var(--c-fill);color:var(--c-txt-on-fill);">カテゴリー名</span>
				...
				`,M(),_(),a},p={Default:{},NoGap:{size:"none"},Small:{size:"s"},Middle:{size:"m"},ExtraSmall:{size:"xs"}},T={title:"Components/Media",tags:["autodocs"],render:r=>{const a=p[r.variant]||{};return G({...a})},args:{label:"Media",variant:"Default"},argTypes:{variant:{control:{type:"select"},options:Object.keys(p),description:"Media gutter variant"},label:{table:{disable:!0}}},parameters:{docs:{description:{component:"\n画像とテキストを水平方向に配置した横長のコンポーネント<br />\n**Show code** または `src/styles/components/_row.scss`をご確認ください。\n- `.c-mda`:**Media**コンポーネント\n- `.c-mda__img`:画像部分の子要素\n- `.c-mda__txt`:テキスト部分の子要素\n- `--row-narrow`:画像側の横幅を調整するカスタムプロパティ\n            "}}}},t={args:{variant:"Default"}},s={args:{variant:"NoGap"},parameters:{docs:{description:{story:"Gap `none`"}}}},e={args:{variant:"Small"},parameters:{docs:{description:{story:"Gap `s`"}}}},i={args:{variant:"Middle"},parameters:{docs:{description:{story:"Gap `m`"}}}},n={args:{variant:"ExtraSmall"},parameters:{docs:{description:{story:"Gap `xs`"}}}};var o,c,m;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    variant: 'Default'
  }
}`,...(m=(c=t.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var d,l,u;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    variant: 'NoGap'
  },
  parameters: {
...
}`,...(u=(l=s.parameters)==null?void 0:l.docs)==null?void 0:u.source}}};var g,b,x;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    variant: 'Small'
  },
  parameters: {
...
}`,...(x=(b=e.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var w,h,v;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    variant: 'Middle'
  },
  parameters: {
