import{f as E}from"./index-APiCpyG9.js";/* empty css                *//* empty css               *//* empty css             *//* empty css                *//* empty css              *//* empty css                 *//* empty css                   *//* empty css              *//* empty css             *//* empty css                    *//* empty css              *//* empty css                *//* empty css                *//* empty css              */const A=()=>{const n=document.querySelectorAll(".c-btn--hbg"),t=document.querySelector(".j-menu"),l=document.querySelector(".c-menu-bg"),o=()=>{n.forEach(s=>{s.setAttribute("aria-expanded","false"),s.blur()}),t&&(t.classList.remove("is-open"),t.close())},u=()=>{t&&(t.classList.contains("is-open")?o():(n.forEach(s=>{s.setAttribute("aria-expanded","true"),s.blur()}),t.classList.add("is-open"),t.show()))};n.length>0&&n.forEach(s=>{s.addEventListener("click",()=>u())}),l&&l.addEventListener("click",o);let c=!1;const m=()=>{c||(requestAnimationFrame(()=>{o(),c=!1}),c=!0)};window.addEventListener("load",o),window.addEventListener("resize",m)},D=({ariaExpanded:n=!1,onClick:t})=>{let l=n;const o=e=>{l=e},u=()=>{const e=document.createElement("button");return e.type="button",e.setAttribute("aria-label","#"),e.setAttribute("aria-controls","sidebar"),e.setAttribute("aria-expanded",String(l)),e.innerHTML='<span class="c-hbg-bars"></span>',e.className="o-bx c-btn--txt c-btn--sq c-btn--hbg",e.addEventListener("click",F=>{const x=!l;o(x),e.setAttribute("aria-expanded",String(x)),A(),typeof t=="function"&&t(F)}),e},c=document.createElement("div"),m=u(),s=u();c.appendChild(m);const a=document.createElement("dialog");a.className="j-menu",a.id="sidebar";const p=document.createElement("div");p.className="o-ctr u-ins-ctr u-space-m u-dsp-flx u-py-s u-flx-y-ctr",p.appendChild(s),a.appendChild(p);const d=document.createElement("nav");d.className="u-mb-l";const h=document.createElement("ul");h.className="o-stc",h.innerHTML=`<li>
            <a
              class="c-prg-l c-a u-fnt-en u-fnt-wm u-dsp-blc u-py-s u-px-m"
              href="#"
            >
							Top
						</a>
	...
	`,d.appendChild(h),a.appendChild(d);const f=document.createElement("ul");f.className="o-stc u-mb-xl",f.innerHTML=`<li>
          <a
            class="c-prg-m c-a u-fnt-en u-fnt-wl u-dsp-blc u-py-s u-px-m"
            href="#"
          >
						Company
					</a>
        ...
        </li>`,a.append(f);const r=document.createElement("a");r.className="c-logo c-logo--menu u-dsp-flx u-flx-ctr u-mb-xl",r.title="仮面ライター",r.setAttribute("aria-label","仮面ライターのトップページへ"),r.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1048 563">
          <path
            class="c-logo-fll"
        ...
        <span class="sr-only">仮面ライターのトップページへ</span>`,a.appendChild(r);const w=document.createElement("ul");w.className="o-cls u-flx-ctr u-mb-xl",w.innerHTML=`<li>
          <a
        ...
        </li>`,a.appendChild(w);const g=document.createElement("div");g.className="c-sml-l u-txt-ctr u-fnt-en u-pb-xl",g.innerText="©︎ kamenwriter.com",a.appendChild(g),c.appendChild(a);const b=document.createElement("div");return b.className="c-menu-bg",c.appendChild(b),c},O={title:"Components/Drawer",tags:["autodocs"],render:({...n})=>D({...n}),argTypes:{onClick:{action:"onClick"}},args:{onClick:E()}},i={};var v,C,y,L,z;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:"{}",...(y=(C=i.parameters)==null?void 0:C.docs)==null?void 0:y.source},description:{story:"`dialog`を用いた**Drawer**コンポーネント<br />\n**Show code** または \\`src/styles/components/_menu.scss\\`をご確認ください。\n- `.j-menu`:**Drawer**コンポーネント\n- `.c-menu-bg`:**Drawer**背景コンポーネント",...(z=(L=i.parameters)==null?void 0:L.docs)==null?void 0:z.description}}};const R=["Examples"];export{i as Examples,R as __namedExportsOrder,O as default};
