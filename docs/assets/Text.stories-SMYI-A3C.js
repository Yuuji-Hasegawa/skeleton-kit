/* empty css                *//* empty css               *//* empty css                 *//* empty css                    *//* empty css              *//* empty css                */const r=()=>{const u=document.createElement("div");return u.className="o-stc",u.innerHTML=`<h2 class="c-h2-ext u-mb-l u-fnt-wb">LineHeights</h2>
	<ul class="o-cls">
	...
	</ul>`,u},g={title:"Utility/Text",tags:["autodocs"],render:()=>r()},t={};var l,i,s,e,a;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:"{}",...(s=(i=t.parameters)==null?void 0:i.docs)==null?void 0:s.source},description:{story:"- `u-lnh-*`:`line-height: *`を設定するユーティリティ\n- `u-txt-*`:`text-align: *` または色や下線を設定するユーティリティ\n- `u-fnt-w*`:`font-weight: *`を設定するユーティリティ\n- `u-fnt-*`:`font-family: *`を設定するユーティリティ\n- `u-txt-trim--*`:テキストトリミングを設定するユーティリティ\n詳細は、`/src/styles/utils/_text.scss`をご確認ください。",...(a=(e=t.parameters)==null?void 0:e.docs)==null?void 0:a.description}}};const x=["Examples"];export{t as Examples,x as __namedExportsOrder,g as default};
