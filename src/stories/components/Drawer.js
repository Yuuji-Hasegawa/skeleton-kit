...
export const createDrawer = ({
    ...
    button.innerHTML = `<span class="c-hbg-bars"></span>`;
    button.className = 'o-bx c-btn--txt c-btn--sq c-btn--hbg';
	...
	Menu.className = 'j-menu'
	Menu.id = 'sidebar'
	const MenuHeader = document.createElement('div')
	MenuHeader.className = 'o-ctr u-ins-ctr u-space-m u-dsp-flx u-py-s u-flx-y-ctr'
	MenuHeader.appendChild(Button2)
	Menu.appendChild(MenuHeader)
	const Nav = document.createElement('nav')
	Nav.className = 'u-mb-l'
	const NavList = document.createElement('ul')
	NavList.className = 'o-stc'
	...
	BottomList.className = 'o-stc u-mb-xl'
	BottomList.innerHTML = `<li>
          <a
	...
	Menu.append(BottomList)
	const Logo = document.createElement('a')
	Logo.className = 'c-logo c-logo--menu u-dsp-flx u-flx-ctr u-mb-xl'
	Logo.title = '仮面ライター'
	Logo.setAttribute('aria-label', '仮面ライターのトップページへ')
	Logo.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1048 563">
          <path
            class="c-logo-fll"
	...
	SnsList.className = 'o-cls u-flx-ctr u-mb-xl'
	...
	Menu.appendChild(SnsList)
	const Copyright = document.createElement('div')
	Copyright.className = 'c-sml-l u-txt-ctr u-fnt-en u-pb-xl'
	Copyright.innerText = '©︎ kamenwriter.com'
	Menu.appendChild(Copyright)
	Drawer.appendChild(Menu)
	const MenuBg = document.createElement('div')
	MenuBg.className = 'c-menu-bg'
	Drawer.appendChild(MenuBg)
